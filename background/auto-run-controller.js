        ...
        while (attemptRun <= maxAttemptsForRound) {
          ...
          try {
            ...
            const canRetry = !blockedByAddPhone
              ...
              && autoRunSkipFailures
              && attemptRun < standardMaxAttemptsForRound;
            ...
            if (blockedByPlusNonFreeTrial) {
              if (await restartCurrentRoundOnGlobalExit(' Plus 免费试用资格不可用', reason)) {
                if (stoppedEarly) {
                  break;
                }
                continue;
            ...
            if (blockedByGpcTaskEnded) {
              if (await restartCurrentRoundOnGlobalExit(' GPC 任务已结束', reason)) {
                if (stoppedEarly) {
                  break;
                }
                continue;
