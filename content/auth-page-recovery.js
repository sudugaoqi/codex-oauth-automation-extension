(function authPageRecoveryModule(root, factory) {
  ...
  function createAuthPageRecovery(deps = {}) {
    ...
    function getAuthTimeoutErrorPageState(options = {}) {
      ...
      if (!titleMatched && !detailMatched && !routeErrorMatched && !fetchFailedMatched && !maxCheckAttemptsBlocked && !signupRestartCurrentAttemptBlocked && !userAlreadyExistsBlocked) {
        return null;
      }
