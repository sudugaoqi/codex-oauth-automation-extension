...
async function resetState() {
  ...
  currentState = {
    ...
    usedSignupPhoneNumbers: { ...(prev.usedSignupPhoneNumbers || {}) },
...
(async () => {
  ...
  assert.deepStrictEqual(
    snapshot.currentState.usedSignupPhoneNumbers,
    {
      '+66 95 991 0002': true,
    },
    'used signup phone number set should survive fresh-attempt reset'
  );
